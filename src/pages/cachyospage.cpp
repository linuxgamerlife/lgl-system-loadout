...
void CachyOSPage::initializePage()
{
    ...
    infoLabel->setWordWrap(true); infoLayout->addWidget(infoLabel); layout->addWidget(infoBox); layout->addSpacing(8);
    ...
    addItem("scxctl",      "scxctl",      "CLI utility for querying and switching SCX schedulers at runtime.",       false);
    ...
    _checks.append({"scxctl", []{ return isDnfInstalled("scxctl") || isDnfInstalled("scx-scheds"); }});
